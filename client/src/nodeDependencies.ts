...
export class DepNodeProvider implements vscode.TreeDataProvider<Dependency> {
	...
	private getDefineInfo(key:string, defineMeta:Object, owner:string = ""):Dependency[] {
		let dependencys: Dependency[] = [];
	...
	private getDepsInDefineJson(key: string): Dependency[] {
		let dependencys: Dependency[] = [];
...
export class Dependency extends vscode.TreeItem {
	...
	iconPath = path.join(__filename, '..', '..', '..', 'resources', 'function_w.png');
